...
urlpatterns = [
    ...
    path('v1/user/shares/', UserSharesView.as_view(), name='user_shares'), # get
    path('v1/companies/', CompanyListView.as_view(), name='companies'), # get
    path('v1/companies/recipes/', CompanyRecipes.as_view(), name='companies-recipes'), # get | post
    ...
    path('v1/companies/<str:ticker>/exchange/', CompanyPrintNewSharesApiView.as_view(), name='company_print_shares'), # post
    ...
    path('v1/stock/gold/', StockGoldApiView.as_view(), name='gold_to_silver_price'), # get
    path('sse/stock/gold/', actual_gold_price_sse_stream, name='gold_to_silver_actual_price'), # get
    ...
    path('v1/stock/shares-exchange/', SharesWholesaleListApiView.as_view(), name='shares-list'), # get
