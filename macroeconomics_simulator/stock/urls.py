...
urlpatterns = [
    ...
    path('v1/companies/<str:ticker>/exchange/<int:shares_type>/', CompanyIncreaseSharesApiView.as_view(), name='company_increase_shares'), # post
    path('v1/companies/<str:ticker>/sell-shares/<int:shares_type>/', CompanySellShareApiView.as_view(), name='company_sell_shares'), # post
    ...
    path('v1/stock/shares-exchange/<str:ticker>/<int:shares_type>/', SharesExchangeApiView.as_view(), name='shares-exchange'), # post
